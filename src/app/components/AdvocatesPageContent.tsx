...
export default function AdvocatesPageContent() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-teal-50 to-emerald-100">
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-6">
            <div className="flex items-center justify-center gap-4 text-sm text-gray-600">
              <span className="flex items-center gap-2">
                ...
                <span className="font-semibold text-teal-700">{searchResults.total}</span>
                advocates found
              </span>
              {searchTerm && (
        ...
        {/* Help Section */}
        <div className="mt-8 bg-gradient-to-r from-teal-600 to-emerald-600 rounded-xl shadow-lg text-white p-6" style={{background: 'linear-gradient(to right, #347866, #10B981)'}}>
